    ...
    app.globalData.calendarLogs = [
      {
        ...
        repeatAlert: false,
        outfitName: '职场干练风',
        items: [app.globalData.wardrobeItems[2], app.globalData.wardrobeItems[6]]
      },
      {
        date: '2026-05-04',
        rating: 4,
        repeatAlert: true,
        outfitName: '休闲白衬衫搭配',
        items: [app.globalData.wardrobeItems[0], app.globalData.wardrobeItems[1]]
      },
      {
        date: '2026-05-05',
        rating: 5,
        repeatAlert: false,
        outfitName: '冷感羊绒松弛感',
        items: [app.globalData.wardrobeItems[3], app.globalData.wardrobeItems[6]]
      },
      {
        date: '2026-05-06',
        rating: 4,
        repeatAlert: false,
        outfitName: '羊西装利索装',
        items: [app.globalData.wardrobeItems[2], app.globalData.wardrobeItems[0]]
      },
      {
        date: '2026-05-07',
        rating: 3,
      ...
      },
      {
        ...
        repeatAlert: true,
        outfitName: '大衣配西裤精英感',
        items: [app.globalData.wardrobeItems[4], app.globalData.wardrobeItems[6]]
      },
      {
        date: '2026-05-11',
        rating: 4,
        ...
        items: [app.globalData.wardrobeItems[4], app.globalData.wardrobeItems[1]]
      },
      {
        date: '2026-05-12',
        rating: 5,
        repeatAlert: true,
        outfitName: '全白衬托配西裤',
        items: [app.globalData.wardrobeItems[0], app.globalData.wardrobeItems[6]]
      },
      {
        date: '2026-05-13',
        rating: 4,
